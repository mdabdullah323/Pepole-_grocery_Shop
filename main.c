...
void gotoxy(int x,int y)//cursor desire posiyion

{

    coord.X=x;// horijental 
...
//textcolor(0);
...

    {
        ...
        fseek(file,0,SEEK_END);// set the file point 

        fwrite(&item,sizeof(item),1,file);//tota number f element in file 
...

{
    ...
    fflush(file);//clear the privious output 
